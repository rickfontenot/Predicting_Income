...
Run Simple Logistic regression with and without NA to compare, add AUC metric
...
Run Complex Logistic regression with and without NA to compare, add AUC metric
...
Run knn-regression with and without NA to compare, add AUC metric
